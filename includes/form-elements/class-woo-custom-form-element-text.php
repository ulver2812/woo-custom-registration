...
class Woo_Custom_Form_Element_Text implements Woocommerce_Custom_Registration_iForm_Element
{
...
HTML;
    ...
    public static function elementRendering($element)
    {
        ...
        <p class="form-row form-row-wide">
            <label for="<?php echo $name; ?>"><?php echo $label; ?> <?php echo $required === '1' ? '<span class="required">*</span></label>' : ''; ?></label>
