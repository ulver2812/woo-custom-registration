...
class Woo_Custom_Form_Element_Textarea implements Woocommerce_Custom_Registration_iForm_Element
{
...
HTML;
    ...
    public static function elementAdminUserProfileRendering($element, $customer_id)
    {
        ...
        <tr>
            ...
            <td>
                <textarea
                        class="regular-text" <?php echo $element['required'] === '1' ? 'required' : ''; ?> name="<?php echo $element['name']; ?>"
                        id="<?php echo $element['name']; ?>">
                    <?php echo $value; ?>
                </textarea>
                <span style="display: block;" class="description"><?php echo $element['description']; ?></span>
            </td>
        </tr>
        <?php
    }
    ...
    public static function elementPublicUserProfileRendering($element, $customer_id)
    {
        ...
        <p class="form-row form-row-wide">
            <label for="<?php echo $element['name']; ?>"><?php echo $element['label']; ?> <?php echo $element['required'] === '1' ? '<span class="required">*</span></label>' : ''; ?>
                <textarea <?php echo $element['required'] === '1' ? 'required' : ''; ?> name="<?php echo $element['name']; ?>" id="<?php echo $element['name']; ?>">
                    <?php echo $value; ?>
                </textarea>
